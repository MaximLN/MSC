...
import ru.msc.AuthorizedUser;
import ru.msc.Profiles;
import ru.msc.model.AbstractBaseEntity;
import ru.msc.model.User;
import ru.msc.repository.UserRepository;
import ru.msc.to.UserTo;
import ru.msc.util.UserUtil;
import ru.msc.util.exception.UpdateRestrictionException;

import java.util.List;

import static ru.msc.util.UserUtil.prepareToSave;
import static ru.msc.util.validation.ValidationUtil.checkNotFound;
